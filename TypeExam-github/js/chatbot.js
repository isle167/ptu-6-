  ...
  window.sendChatMessage = async function () {
    ...
    try {
      const response = await fetch(
        `https://sqrxsjbxunppcfbreaxa.supabase.co/functions/v1/ai-chat`,
        {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
            'Authorization': `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNxcnhzamJ4dW5wcGNmYnJlYXhhIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzgwMzY2NDcsImV4cCI6MjA5MzYxMjY0N30.b2OgYUWtGhj1srdbfdez4u-igL7P3JUJKtuYYxeJhjg`
          },
